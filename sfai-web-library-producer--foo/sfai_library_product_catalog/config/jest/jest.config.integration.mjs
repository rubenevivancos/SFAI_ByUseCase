...
export default {
  ...
  setupFilesAfterEnv: [
    ...
    path.resolve(rootDir, 'config/jest/setup/jest.setup.integration.ts') // Ruta absoluta para setup
  ],
  transform: {
  ...
  moduleNameMapper: {
    ...
    '^@sfai-library-mjs/(.*)$': path.resolve(getSafeAbsRootPath(), 'sfai_library_mjs/$1')  // TODO: migrate to external dependency
  },
